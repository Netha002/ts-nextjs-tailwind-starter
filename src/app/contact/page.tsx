      ...
      <div className='layout'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
          ...
          <div className='bg-alternate p-12 rounded-3xl space-y-8'>
            <h3 className='font-primary text-primary text-[32px] mb-8'>
              Clinic Details
            </h3>
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div>
                <h4 className='font-primary text-primary text-[20px] mb-2'>
                  Location
                </h4>
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div>
                ...
                <a
                  href='tel:9347871336'
                  className='font-secondary text-text hover:text-accent transition-colors'
                >
                  9347871336
                </a>
              </div>
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div>
                ...
                <a
                  href='mailto:info@aylaluxedermatology.com'
                  className='font-secondary text-text hover:text-accent transition-colors'
                >
                  info@aylaluxedermatology.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className='bg-primary p-12 rounded-3xl text-alternate'>
            <h3 className='font-primary text-alternate text-[32px] mb-8'>
              Send a Message
            </h3>
            <form className='space-y-6'>
              <div>
                <label className='block font-secondary text-[14px] mb-2'>
                  Your Name
                </label>
                <input
                  type='text'
                  className='w-full bg-alternate/10 border border-alternate/20 rounded-xl px-4 py-3 text-alternate placeholder-alternate/50 focus:outline-none focus:border-accent'
