    ...
    <div className='w-full relative'>
      ...
      <section className='relative w-full h-screen flex flex-col justify-center overflow-hidden bg-black'>
        ...
        <div className='layout relative z-20 flex flex-col justify-center h-full'>
          ...
          >
            <motion.h1
              variants={fadeInUp}
              className='font-primary text-[36px] md:text-[68px] leading-[1.05em] tracking-tight text-white mb-6 md:mb-8 mt-24 md:mt-0'
            >
            ...
            <motion.p
              variants={fadeInUp}
              className='font-secondary text-[16px] md:text-[20px] font-medium text-white mb-10 md:mb-12'
            >
              Advanced dermatology & aesthetic care for skin, hair and
              aesthetics.
            </motion.p>
      ...
      <section id='about' className='py-24 bg-background'>
        ...
        >
          ...
          <motion.h3
            variants={fadeInUp}
            className='font-secondary text-primary text-[14px] uppercase tracking-[0.2em] mb-10'
          >
        ...
        <section className='py-24 bg-alternate'>
          <div className='layout flex flex-col items-center'>
            ...
            >
              <Link
                href='/treatments'
                className='inline-flex items-center gap-2 border border-primary/30 rounded-full px-8 py-3 text-primary font-secondary text-[16px] hover:bg-primary hover:text-white transition-colors'
              >
        ...
        <div className='layout'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-16 items-center'>
            ...
            >
              <motion.h2
                variants={fadeInUp}
                className='font-primary text-[42px] md:text-[56px] text-primary mb-2'
              >
                DR. DIVYA SREE VARRI
              </motion.h2>
              <motion.h4
                variants={fadeInUp}
                className='font-secondary text-[14px] font-bold tracking-widest text-text uppercase mb-12'
              >
                MD, CHIEF CONSULTANT DERMATOLOGIST, CLINICAL &<br />
                AESTHETIC DERMATOLOGY
              </motion.h4>

              <motion.h3
                variants={fadeInUp}
                className='font-primary text-[24px] text-text mb-6'
              >
                WHAT WE DO?
              </motion.h3>
              <motion.p
                variants={fadeInUp}
                className='font-secondary text-text text-[16px] leading-[1.8em]'
              >
                We, at pH5 Aesthetics Clinic offer a wide range of medical and
                cosmetic dermatology services designed to address skin, hair and
                aesthetic concerns with precision and care. Our treatments are
                all customized by our chief dermatology expert to suit
                individual skin types and conditions, ensuring safe procedures
                and visible results.
              </motion.p>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <TiltCard className='relative aspect-[3/4] rounded-2xl overflow-hidden group'>
                ...
                <h3 className='absolute bottom-8 left-8 font-primary text-white text-[32px]'>
                  Skin Concerns
                </h3>
              </TiltCard>
            </motion.div>
            ...
            {/* Hair Concerns Card */}
            <motion.div variants={fadeInUp}>
              <TiltCard className='relative aspect-[3/4] rounded-2xl overflow-hidden group block cursor-pointer'>
                <Image
                  src='/images/luxury-woman-face.jpg'
                  alt='Hair Concerns'
                  fill
                  className='object-cover group-hover:scale-105 transition-transform duration-700'
                />
            ...
            <motion.div variants={fadeInUp}>
              <TiltCard className='relative aspect-[3/4] rounded-2xl overflow-hidden group'>
                <Image
                  src='/images/Screenshot-2026-03-13-100436.webp'
                  alt='Body Concerns'
                  fill
                  className='object-cover group-hover:scale-105 transition-transform duration-700'
                />
                ...
                <div className='absolute top-6 left-6'>
                  <svg
                    ...
                    strokeWidth='1'
                  >
                    <path d='M12 4a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm-4.5 4a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z' />
                  </svg>
                </div>
                <h3 className='absolute bottom-8 left-8 font-primary text-white text-[32px]'>
                  Body Concerns
        ...
        <div className='layout relative z-10'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-16 items-center'>
            ...
            >
              <motion.h2
                variants={fadeInUp}
                className='font-primary text-[50px] md:text-[68px] text-primary mb-12'
              >
                For Appointments
              </motion.h2>
              <motion.div variants={fadeInUp}>
                <BookingCTA href='tel:+919347871336' text='Book Appointment' />
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      {/* Quiz Modal */}
      <TreatmentQuiz isOpen={isQuizOpen} onClose={() => setIsQuizOpen(false)} />
    </div>
  );
}
