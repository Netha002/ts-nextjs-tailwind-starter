      ...
      <div className='layout'>
        ...
        <div className='flex flex-col items-center text-center mb-20'>
          ...
          <p className='font-secondary text-text/80 text-[18px] max-w-2xl mb-10'>
            Explore our comprehensive range of advanced treatments designed to
            illuminate your skin, restore your hair, and reveal your most
            confident self.
          </p>
                ...
                <TiltCard maxTilt={3}>
                  {treatment.beforeAfterPair ? (
                    ...
                    <div className='w-full aspect-[4/3] bg-black/5 rounded-2xl flex items-center justify-center border border-border'>
                      <p className='font-secondary text-text/50 italic'>
