      ...
      <div className='layout'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-12 mb-16'>
          ...
          <div className='col-span-1 md:col-span-1'>
            <Link
              href='/'
              className='inline-block mb-6 relative w-[160px] h-[100px]'
            >
              <Image
            ...
            <p className='font-secondary text-alternate/80 mb-6'>
              Ayla Luxe Dermatology is a premium skin, hair and aesthetic clinic
              in Chennai offering advanced treatments and personalized care.
            </p>
            <div className='flex gap-4'>
              <a
                href='#'
                className='w-10 h-10 rounded-full border border-alternate/20 flex items-center justify-center hover:bg-accent hover:text-secondary hover:border-accent transition-colors'
              >
                <Facebook size={18} />
              </a>
              <a
        ...
        <div className='pt-8 border-t border-alternate/20 flex flex-col md:flex-row justify-between items-center gap-4 font-secondary text-sm text-alternate/60'>
          <p>
            © {new Date().getFullYear()} Ayla Luxe Dermatology. All Rights
            Reserved.
          </p>
        </div>
      </div>
